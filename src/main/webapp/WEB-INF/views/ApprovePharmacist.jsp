...
$(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            ...
            if(flag == 0){
            	$("#table").remove();
            	$("#content").append("<p>All the pharmacist accounts have been approved</p>")
            }
    ...
    $(document).on("click", '#approve',function(){
        ...
        $.ajax({
        	cache: false,
            type: "POST",
            url: "approvepharmacist.htm?accountid=" + accountid,
            success: function(data) {          	
            	location.reload();
            }
        });
    ...
    $(document).on("click", 'button',function(){
        if(!isNaN(this.id)){
            ...
            $.ajax({
            	cache: false,
                type: "POST",
                url: "pharmacisttable.htm?cpage=" + cpage,
                success: function(data) {
                	debugger;
                    var jsondata = JSON.parse(data);
                    var tabledata = jsondata.list;
...
<title>Approve Pharmacist</title>
</head>
<body BACKGROUND="doctorbackground.jpg"/>
<center>
<br><br><br>
<h1>Approve Pharmacist</h1>
<table id="table" border="1">
<tr><td>Name</td><td>Telephone</td><td>Organization Name</td><td>Organization Type</td><td>Status</td></tr>
</table><br>
<div id="content"></div>
<div id="pages"></div>
<br>
